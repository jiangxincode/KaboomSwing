...
public class StackedTableLayout implements LayoutManager {
	
	public StackedTableLayout() {
		this(5, 15, true);
	}
	
	public StackedTableLayout(int minRows, int prefRows, boolean fillHeight) {
